namespace Barometer.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BaroDB>
    {
        ...
        protected override void Seed(BaroDB context)
        {
            ...
            ////sq1 = context.SubjectQuestions.ToList().ElementAt(5);
            ////sq2 = context.SubjectQuestions.ToList().ElementAt(6);
            ////sq3 = context.SubjectQuestions.ToList().ElementAt(7);
            ////sq4 = context.SubjectQuestions.ToList().ElementAt(8);
            ////sq5 = context.SubjectQuestions.ToList().ElementAt(9);
            ////sq6 = context.SubjectQuestions.ToList().ElementAt(10);
            ////sq7 = context.SubjectQuestions.ToList().ElementAt(11);
            ////sq8 = context.SubjectQuestions.ToList().ElementAt(12);
